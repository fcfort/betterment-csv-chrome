...
module.exports = function(grunt) {
  ...
  grunt.registerTask('build', [].concat('trimtrailingspaces', 'clean:dist',
                                        'replace:dist', 'concat', 'browserify',
                                        'copy:dist'));
  grunt.registerTask('test',
                     [].concat('build', 'mochaTest', 'clean:karma',
                               'copy:karma', 'browserify:karma', 'unittests'));
  grunt.registerTask('package',
                     [].concat('test', 'copy:dist', 'crx', 'clean:crx'));
